...
export default function ScrollHorOne() {
  return (
    <section className="bg-white py-7 border-y-0 border-zinc-100 dark:bg-[#050505]">
      <div className="container  mx-auto px-4 sm:px-6 mb-5 text-center">
      </div>
